...
void test_push_pop() {
    ...
    std::cout << "  ✓ PUSH/POP works correctly" << std::endl;
}
...
void test_dup() {
    ...
    std::cout << "  ✓ DUP works correctly" << std::endl;
}
...
void test_swap() {
    ...
    std::vector<uint64_t> program = {
        ...
        static_cast<uint64_t>(Opcode::SWAP),
        static_cast<uint64_t>(Opcode::HALT)
    };
...
void test_stack_underflow() {
    std::cout << "Testing stack underflow detection..." << std::endl;
    ...
    assert(caught);
    std::cout << "  ✓ Stack underflow detected correctly" << std::endl;
}

void test_multiple_operations() {
    std::cout << "Testing complex stack operations..." << std::endl;
    ...
    assert(vm.get_top() == 3);
    std::cout << "  ✓ Complex stack operations work correctly" << std::endl;
}

int main() {
    std::cout << "=== VM Stack Operations Tests ===" << std::endl;
    ...
    try {
        ...
        std::cout << "\n✓ All stack operation tests passed!" << std::endl;
        return 0;
