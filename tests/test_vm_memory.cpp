...
void test_multiple_stores() {
    std::cout << "Testing multiple STORE operations..." << '\n';
    ...
    std::cout << "  ✓ Multiple stores work correctly" << '\n';
}
...
void test_memory_as_array() {
    std::cout << "Testing memory as array..." << '\n';
    ...
    std::cout << "  ✓ Memory can be used as array" << '\n';
}

void test_read_write_cycle() {
    std::cout << "Testing read-modify-write cycle..." << '\n';
    ...
    std::cout << "  ✓ Read-modify-write cycle: 10 + 5 = 15" << '\n';
}

int main() {
    std::cout << "=== VM Memory Operations Tests ===" << '\n';
