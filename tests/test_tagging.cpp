...
void run_lisp_code(const std::string& source, LispCompiler& compiler) {
    try {
        ...
        std::cout << "Compiled " << exprs.size() << " expressions into " 
                  << bytecode.size() << " words of bytecode" << std::endl;
        ...
        std::cout << "SP: " << vm.get_sp() << std::endl;
...
int main() {
    std::cout << "=== Tagged Pointer Demo ===" << std::endl << std::endl;
    ...
    std::cout << "--- Testing Integer Tagging ---" << std::endl;
    ...
    // Test OOP tagging
    std::cout << "--- Testing OOP Tagging ---" << std::endl;
    run_lisp_code(
        "(do "
        "  (define TAG_MASK 7)"
    ...
    std::cout << "--- Testing Full Tagging Functions ---" << std::endl;
    run_lisp_code(
        "(do "
        "  (define TAG_MASK 7)"
        "  (define TAG_INT 1)"
